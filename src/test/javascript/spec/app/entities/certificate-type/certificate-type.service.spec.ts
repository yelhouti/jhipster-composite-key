    ...
    describe('CertificateType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/certificate-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CertificateType', () => {
                service.create(new CertificateType(null)).subscribe(received => {
            ...
            it('should update a CertificateType', () => {
                service.update(new CertificateType(123)).subscribe(received => {
            ...
            it('should return a CertificateType', () => {
            ...
            it('should return a list of CertificateType', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CertificateType(123)]);
            });
